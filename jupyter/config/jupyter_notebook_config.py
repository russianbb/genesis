...
#  Default: ''
c.NotebookApp.notebook_dir = "/code/jupyter/notebooks"
...
#  Choices: any of ['sha3_256', 'sha224', 'sha256', 'md5', 'sha3_224', 'sha3_512', 'sha512', 'sha384', 'blake2s', 'sha3_384', 'sha1', 'blake2b']
#  Default: 'sha256'
