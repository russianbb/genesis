...
class OnixProduct(AbstractBaseModel):
    ...
    unit_volume = models.DecimalField(verbose_name='Volume', max_digits=7, decimal_places=3, help_text='Fator de multiplicação da unidade vendida. Difere da embalagem em casos de caixas, frascos, pacotes, etc')
...
class SyngentaProduct(AbstractBaseModel):
    onix = models.ForeignKey(OnixProduct, on_delete=models.CASCADE, verbose_name='Produto Onix')
