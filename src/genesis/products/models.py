...
class OnixProduct(AbstractBaseModel):
    ...
    description = models.CharField(
        ...
        max_length=200,
        help_text=(
            "Normalmente segue o padrão: "
            "Nome do Produto - Tamanho da Embalagem Tipo de Unidade."
        ),
    )
    prefix = models.CharField(
        ...
        max_length=150,
        help_text=(
            "Apenas o nome, sem complementos. "
            "Exemplo: Cruiser, Cruiser Opti, Zapp QI, Zapp Pro."
        ),
    )
    unit_size = models.CharField(
        ...
        max_length=4,
        help_text=(
            "Tamanho da unidade vendida. " 'Se for vendido em caixa, utilize " 1 ".'
        ),
    )
    ...
    unit_volume = models.DecimalField(
        ...
        decimal_places=3,
        help_text=(
            "Fator de multiplicação da unidade vendida. "
            "Difere da embalagem em casos de caixas, frascos, pacotes, etc"
        ),
    )
...
class CompanyProduct(AbstractBaseModel):
    ...
    code = models.CharField(
        ...
        verbose_name="Código",
        help_text=(
            "Código utilizado pelo distribuidor para "
            "identificar o produto nos relatórios.",
        ),
    )
    description = models.CharField(
        max_length=80,
        ...
        help_text=(
            "Descrição utilizado pelo distribuidor para "
            "identificar o produto nos relatórios."
        ),
    )
