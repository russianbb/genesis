...
class OnixProductAdmin(ExportMixin, admin.ModelAdmin):
    ...
    list_display = ('id', 'description', 'prefix', 'unit_size', 'unit_mesure', 'unit_volume')
    list_display_links = ('description',)
    search_fields = ('id', 'description', 'prefix', 'unit_size', 'unit_mesure', 'unit_volume')
...
class SyngentaProductAdmin(ExportMixin, admin.ModelAdmin):
    ...
    list_display = ('agicode', 'description', 'family', 'get_onix_id', 'get_onix_description', 'updated_at')
